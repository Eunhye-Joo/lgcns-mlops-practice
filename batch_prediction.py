...
if __name__ == "__main__":
    ...
    logger.info("Saving the feature data for test data...")
    model['preprocessor'].transform(X=X).to_csv(os.path.join(DATA_PATH,"storage","house_rent_features.csv"), index = False)
    ...
    logger.info("Prediction can be found in the following path : \n" f"{save_path}")